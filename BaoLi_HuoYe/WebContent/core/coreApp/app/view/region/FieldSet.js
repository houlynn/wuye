 ...
 * 
 */
Ext.define('core.app.view.region.FieldSet', {
			extend : 'Ext.form.FieldSet',
			alias : 'widget.formfieldset',
			requires : ['core.app.module.factory.FieldContainerFactory',
					'core.app.module.factory.FormFieldFactory'],
			...
			initComponent : function() {
				...
				for (var i in containers) {
					this.items.push(core.app.module.factory.FieldContainerFactory
							.getContainer(containers[i], this.viewModel, this.formtype));
				}
				...
				for (var i in hiddens) {
					var field = hiddens[i];
					var fieldDefine = this.viewModel.getFieldDefine(field.tf_fieldId);
					var f = core.app.module.factory.FormFieldFactory.getField(
