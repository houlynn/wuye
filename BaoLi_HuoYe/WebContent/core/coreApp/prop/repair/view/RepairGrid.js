 ...
 * 报修单
 */
Ext.define("core.prop.repair.view.RepairGrid",{
	extend : 'Ext.grid.Panel',
	alias : 'widget.repair.grid',
	funData:{
	   code:302,
	},
autoHeight:true,
	...
	if(!this.thar){
	 ...
	 barItem=Ext.apply(thar,this.thar);
   	...
   	var viewModel=system.getViewModel(302)
   		this.model = core.app.module.factory.ModelFactory.getModelByModule(viewModel.data,{read : '/vi/loadRepair.action'});
