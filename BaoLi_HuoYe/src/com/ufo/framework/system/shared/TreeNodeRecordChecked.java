...
public class TreeNodeRecordChecked extends TreeNodeRecord {
	...
	public TreeNodeRecordChecked(String moduleName, String tableAsName, String text,
			String fieldname, String fieldvalue, String equalsMethod, Boolean isCodeLevel) {
