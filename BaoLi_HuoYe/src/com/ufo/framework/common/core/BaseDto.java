package com.ufo.framework.common.core;
...
import com.ufo.framework.common.core.json.JsonHelper;
import com.ufo.framework.common.core.utils.TypeCaseHelper;
import com.ufo.framework.common.core.xml.XmlHelper;
/**
 * 数据传输对象(DateTransferObject)<br>
 * 建议在参数传递过程中尽量使用Dto来传递<br>
* @author 作者 yingqu: 
* @version 创建时间：2014年6月28日 下午5:06:43 
* version 1.0
 */
public class BaseDto extends HashMap<String,Object> implements Dto, Serializable {
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(CommConstants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(CommConstants.XML_Node))
			// 节点元素值风格
